                    ...
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-gray-800 rounded-lg shadow-md m-4 p-4 text-white">
                            ...
                            <div className="flex justify-between my-2">
                                ...
                                <button className="rounded p-2 bg-white text-black" onClick={() => togglePopup(el)}>
